...
srcdir = ext/signer
topdir = /Users/bbuck/.rvm/rubies/ruby-2.2.2/include/ruby-2.2.0
hdrdir = $(topdir)
arch_hdrdir = /Users/bbuck/.rvm/rubies/ruby-2.2.2/include/ruby-2.2.0/x86_64-darwin14
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/bbuck/.rvm/rubies/ruby-2.2.2
...
ORIG_SRCS = signer.c signer_str.c stack.c
SRCS = $(ORIG_SRCS) 
OBJS = signer.o signer_str.o stack.o
HDRS = $(srcdir)/signer_str.h $(srcdir)/stack.h
TARGET = signer
TARGET_NAME = signer
